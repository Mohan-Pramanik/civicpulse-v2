...
export function SkeletonCard() {
  return (
    <div className="card" style={{ marginBottom:'1rem' }}>
      <div className="shimmer" style={{ height:16, width:'60%', marginBottom:10, borderRadius:6 }} />
      <div className="shimmer" style={{ height:12, width:'40%', marginBottom:8, borderRadius:6 }} />
